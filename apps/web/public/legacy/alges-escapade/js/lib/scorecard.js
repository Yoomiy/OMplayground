...
function scorecard()
{
    ...
    if ( !($('#game_scorecard').length) )
    {
        ...
        $('#game_scorecard').append('<h1>תוצאות</h1>');
        $('#game_scorecard').append('<p>מספר שכפולים<span class="clones">0</span></p>');
        $('#game_scorecard').append('<p>זמן<span class="time">0ש</span></p>');
        $('#game_scorecard').append('<p class="scoreholder">ניקוד<span class="score"></span></p>');
        $('#game_scorecard').append('<a class="mainMenu" href="#" aria-label="תפריט ראשי">תפריט ראשי</a>');
        $('#game_scorecard').append('<a class="resetLevel" href="#" aria-label="איפוס שלב">איפוס שלב</a>');
        $('#game_scorecard').append('<a class="nextLevel" href="#" aria-label="לשלב הבא">לשלב הבא</a>');
    }
    ...
    var _calcTime = function(){
        ...
        {
            ret = hours+'ש '+minutes+'ד';
        }
        else if ( minutes )
        {
            ret = minutes+'ד '+seconds+'ש';
        }
        else
        {
            ret = seconds+'ש';

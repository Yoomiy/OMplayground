    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-3">
        <div className="flex flex-col gap-0.5">
          <h2 className="text-lg font-bold text-white">פקמן</h2>
          <p className="text-sm font-medium text-white/70">אכלו את כל הגלולות, הימנעו מרוחות הרפאים ושיברו את שיא הניקוד במשחק הקלאסי!</p>
        </div>
        <button
          type="button"
      ...
      >
        <iframe
          ref={iframeRef}
          title="PacmanCanvas"
          src="/legacy/pacman-canvas/index.html"

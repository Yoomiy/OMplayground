...
export function Game2048Solo({ save }: { save: SoloGameSaveControls }) {
    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-3">
        <div className="flex flex-col gap-0.5">
          <h2 className="text-lg font-bold text-white">2048</h2>
          <p className="text-sm font-medium text-white/70">חברו את האריחים והגיעו לאריח ה-2048!</p>
        </div>
        <button
          type="button"

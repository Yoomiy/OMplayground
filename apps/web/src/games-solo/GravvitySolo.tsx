    ...
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-white/10 pb-3">
        <div className="flex flex-col gap-0.5">
          <h2 className="text-lg font-bold text-white">גראביטי</h2>
          <p className="text-sm font-medium text-white/70">שלטו בכוח המשיכה, אספו כוכבים והתחמקו מהכדורים האדומים!</p>
        </div>
        <button
          type="button"
      ...
      >
        <iframe
          ref={iframeRef}
          data-playground-wasm-game="gravvity"
          title="Gravvity"
          src="/legacy/gravvity/index.html"

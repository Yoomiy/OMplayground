...
const BLOCK_HUD: Record<number, string> = {
  ...
  [BLOCK_REGISTRY.WHITE_STAINED_GLASS]: "זכוכית צבועה לבן",
  [BLOCK_REGISTRY.YELLOW_STAINED_GLASS]: "זכוכית צבועה צהוב",
  [BLOCK_REGISTRY.RED_STAINED_GLASS]: "זכוכית צבועה אדום",
  [BLOCK_REGISTRY.PURPLE_STAINED_GLASS]: "זכוכית צבועה סגול",
  [BLOCK_REGISTRY.PINK_STAINED_GLASS]: "זכוכית צבועה ורוד",
  [BLOCK_REGISTRY.ORANGE_STAINED_GLASS]: "זכוכית צבועה כתום",
  [BLOCK_REGISTRY.MAGENTA_STAINED_GLASS]: "זכוכית צבועה מג'נטה",
  [BLOCK_REGISTRY.LIME_STAINED_GLASS]: "זכוכית צבועה ליים",
  [BLOCK_REGISTRY.LIGHT_BLUE_STAINED_GLASS]: "זכוכית צבועה תכלת",
  [BLOCK_REGISTRY.GREEN_STAINED_GLASS]: "זכוכית צבועה ירוק",
  [BLOCK_REGISTRY.GRAY_STAINED_GLASS]: "זכוכית צבועה אפור",
  [BLOCK_REGISTRY.CYAN_STAINED_GLASS]: "זכוכית צבועה טורקיז",
  [BLOCK_REGISTRY.BROWN_STAINED_GLASS]: "זכוכית צבועה חום",
  [BLOCK_REGISTRY.BLUE_STAINED_GLASS]: "זכוכית צבועה כחול",
  [BLOCK_REGISTRY.BLACK_STAINED_GLASS]: "זכוכית צבועה שחור",
  [BLOCK_REGISTRY.SANDSTONE]: "אבן חול",
  [BLOCK_REGISTRY.DIAMOND_ORE]: "עפרת יהלום",
  [BLOCK_REGISTRY.DIAMOND_BLOCK]: "בלוק יהלום",
  [BLOCK_REGISTRY.LAPIS_ORE]: "עפרת לאפיס",
  [BLOCK_REGISTRY.LAPIS_BLOCK]: "בלוק לאפיס",
  ...
  [BLOCK_REGISTRY.GRASS_YELLOW]: "דשא צהוב",
  [BLOCK_REGISTRY.GRASS_PLANT_YELLOW]: "שיח דשא צהוב",
  [BLOCK_REGISTRY.LEAVES_YELLOW]: "עלים צהובים",
  [BLOCK_REGISTRY.GRASS_PLANT]: "שיח דשא"
};
...
const MC_TEX = {
  ...
  waterStill: "/minecraft-assets/block/water.png",
  ...
  dandelion: "/minecraft-assets/block/yellow_flower.png",

  ...
  if (!isAdmin) {
    return (
      <div className="mx-auto max-w-lg p-6">
        <p className="text-amber-300">אין הרשאה — חשבון מנהל נדרש.</p>
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col gap-8 p-6">
      ...
      <section className="space-y-3">
        ...
        <ul className="space-y-3 text-sm">
          {reports.map((r) => (
            <li
              key={r.id}
              className="rounded border border-slate-600 bg-slate-900/40 px-3 py-3"
            >
              ...
              <div className="mt-2 space-y-1 rounded border border-slate-700/80 bg-slate-950/50 p-2 text-right">
                <p className="text-xs font-medium text-slate-400">תוכן מדווח</p>
      ...
      <section className="space-y-2">
        ...
        <textarea
          className="min-h-[120px] w-full rounded border border-slate-600 bg-slate-900 p-2 font-mono text-xs"
          value={csvText}
      ...
      <section className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            type="button"
            variant="outline"
            className="border-rose-700 text-rose-300 hover:bg-rose-950/60"
            disabled={busy}
            onClick={() => {
              if (
                !window.confirm(
